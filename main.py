...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        applicationName = "Auto messenger timer"
...
#--PAGE BUG----------------------------------:
    ...
    #--USING START BUTTON-----------:
        self.ui.bn_bug_start.clicked.connect(self.showrun) #THE FUNCTION GET ACTIVATED WHEN YOU CLICK THE BUTTON
    def showrun(self):
        url="https://www.facebook.com/PCTPC57/"
        runprf=webbrowser.open_new_tab(url)
        url2="https://mail.google.com/mail/u/0/#sent?compose=GTvVlcSMSckHjnQxwXnCpmtVxRvkrwxwGHSfQBwjDNPnTFhxRTlsVvtQLpTBnnGtCGRCxcFZgPXWR"
        runprf=webbrowser.open_new_tab(url2)
#--PAGE CLOUD--------------------------------:
    #--CHANGE HEADING---------------:
    ...
    #--USING THE PUSH BUTTONS-------:
        #self.ui.bn_cloud_clear.clicked.connect(self.run)
        #self.ui.bn_cloud_connect.clikced.connect(self.stop)
